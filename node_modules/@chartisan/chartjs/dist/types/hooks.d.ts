...
export declare class Hooks extends BaseHooks<CC> {
     ...
     */
    borderColors(colors?: (ChartColor | ChartColor[] | Scriptable<ChartColor>)[]): this;
    /**
     * Set the pie colors of the datasets.
     */
    pieColors(colors?: ChartColor[]): this;
    /**
     * Set the pie border colors of the datasets.
     */
    pieBorderColors(colors?: ChartColor[]): this;
    /**
     ...
     */
    beginAtZero(beginAtZero?: boolean, axe?: 'x' | 'y'): this;
    /**
     * Set the chart to begin at zero.
     */
    precision(precision: number, axe?: 'x' | 'y'): this;
    /**
     * Set the chart to begin at zero.
     */
    stepSize(stepSize: number, axe?: 'x' | 'y'): this;
    /**
